  ...
  return (
    <div className="mt-10 px-5">
      ...
      <section className="my-10">
        <div className="grid grid-cols-2 md:grid-cols-4 justify-items-center max-w-4xl mx-auto">
          <div className="grid justify-items-center px-3 py-5 gap-y-5 border-2 border-gray-200 shadow-sm shadow-white rounded-xl">
          ...
          <div className="grid justify-items-center px-5 py-5 gap-y-5 border-2 border-gray-200 shadow-sm shadow-white rounded-xl">
